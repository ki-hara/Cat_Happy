...
namespace HC.UI
{
    public class StoreManagerPopup : UIBase
    {
        #region define color
        ...
        [SerializeField] HCButton topBtn_Furniture;
        [SerializeField] HCButton topBtn_Food;
        [SerializeField] HCButton topBtn_Worker;
        [SerializeField] HCButton cancelBtn;
        [SerializeField] HCButton restaurantBtn;
        [SerializeField] HCButton kitchenBtn;
        [SerializeField] HCButton terraceBtn;
